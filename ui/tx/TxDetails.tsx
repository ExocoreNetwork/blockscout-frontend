...
import usePrecompileDetect from 'lib/hooks/usePrecompileDetect';
...
import TxDetailsPrecompileDetect from 'ui/tx/details/TxDetailsPrecompileDetect';
...
const TxDetails = () => {
  ...
  const { deposit, delegate, withdraw } = usePrecompileDetect(data);
